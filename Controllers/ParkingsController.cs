...
namespace ParkingRoutes.Controllers
{
    public class ParkingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Latitude,Longitude")] Parking parking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Latitude,Longitude")] Parking parking)
        {
            if (id != parking.Id)
            {
                return NotFound();
